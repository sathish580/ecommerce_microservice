# for payments to post amqp messages via topic to email microservice
import pika
...
connection = pika.BlockingConnection(
    ...
    # For rare cases, it's incompatpython amqp_setup.pyibility between RabbitMQ and the machine running it,
